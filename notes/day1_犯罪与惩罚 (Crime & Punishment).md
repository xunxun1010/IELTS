...
penal system：刑罚系统 / 惩罚体系

reintegrate into society：重新融入社会

recidivism rate：累犯率 / 再次犯罪率 (雅思犯罪类核心高分词汇，可替换 re-offending rate)

productive citizens：对社会有贡献的 / 有价值的公民

📝 写作逻辑拆解 (TR & CC 评分标准)
这个段落之所以能拿到高分，不仅在于词汇，更在于其严密的环环相扣的逻辑链：

主题句 (Topic Sentence)：用 "While..." 句型进行让步（承认惩罚有一定作用），顺势引出自己的核心观点（主要功能是改造）。

解释原因 (Explanation)：为什么需要改造？因为犯罪的根源往往是缺乏教育和技能。

提出方案 (Condition)：如果（If）刑罚系统能提供技能培训和心理辅导...

得出结论 (Result)：那么（This approach...）就能降低再犯率，保障社会长治久安。
